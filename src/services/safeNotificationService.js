// Safe notification service that only uses React Native's built-in Alert
// This service is guaranteed to work without any external dependencies

import { Alert } from 'react-native';

class SafeNotificationService {
  constructor() {
    console.log('Safe notification service initialized');
  }
...
export default new SafeNotificationService();
